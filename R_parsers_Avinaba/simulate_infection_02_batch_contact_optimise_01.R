...
SIM_SCRIPT_NAME = 'simulate_infection_02_batch_contact_optimise_01_025_for_60d'
  ...
  for(person_id in 1:TOTAL_SIMULATED_PERSONS){
    ...
    if(PREV_STATE_NAME == "susceptible" || PREV_STATE_NAME == "received_dose1"){
      ...
      if(PREV_STATE_NAME == "received_dose1" && 
         ...
         (day_index - infection_hist_mat[person_id, "dose 1 on"]) >= CONST_MIN_DAYS_TILL_SECOND_DOSE){
